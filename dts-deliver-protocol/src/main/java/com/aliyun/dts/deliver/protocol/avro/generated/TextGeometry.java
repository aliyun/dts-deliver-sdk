...
public class TextGeometry extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7192042154712699772L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TextGeometry\",\"namespace\":\"com.aliyun.dts.deliver.protocol.avro.generated\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"value\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder newBuilder() {
    return new com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder();
  }
   ...
   * @return A new TextGeometry RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder(other);
  }
   ...
   * @return A new TextGeometry RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TextGeometry>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder setType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.TextGeometry.Builder clearValue() {
      value = null;
