...
public class Decimal extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3436041281323108316L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Decimal\",\"namespace\":\"com.aliyun.dts.deliver.protocol.avro.generated\",\"fields\":[{\"name\":\"value\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"precision\",\"type\":\"int\"},{\"name\":\"scale\",\"type\":\"int\"}]}");
   ...
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder newBuilder() {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder();
  }
   ...
   * @return A new Decimal RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder(other);
  }
   ...
   * @return A new Decimal RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.Decimal other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Decimal>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.Decimal other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder clearValue() {
      value = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder setPrecision(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder clearPrecision() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder setScale(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Decimal.Builder clearScale() {
