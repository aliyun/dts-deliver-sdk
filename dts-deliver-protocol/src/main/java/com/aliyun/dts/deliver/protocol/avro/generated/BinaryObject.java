...
public class BinaryObject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3629998463681645501L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BinaryObject\",\"namespace\":\"com.aliyun.dts.deliver.protocol.avro.generated\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"value\",\"type\":\"bytes\"}]}");
   ...
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder newBuilder() {
    return new com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder();
  }
   ...
   * @return A new BinaryObject RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder(other);
  }
   ...
   * @return A new BinaryObject RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BinaryObject>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder setType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder setValue(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.BinaryObject.Builder clearValue() {
      value = null;
