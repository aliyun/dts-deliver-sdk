...
public class Integer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 475054589793836387L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Integer\",\"namespace\":\"com.aliyun.dts.deliver.protocol.avro.generated\",\"fields\":[{\"name\":\"precision\",\"type\":\"int\"},{\"name\":\"value\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder newBuilder() {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder();
  }
   ...
   * @return A new Integer RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder(other);
  }
   ...
   * @return A new Integer RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.Integer other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Integer>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.Integer other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.precision)) {
        this.precision = data().deepCopy(fields()[0].schema(), other.precision);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder setPrecision(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder clearPrecision() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Integer.Builder clearValue() {
      value = null;
