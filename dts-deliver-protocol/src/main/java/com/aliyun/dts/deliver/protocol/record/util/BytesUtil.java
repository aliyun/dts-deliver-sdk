...
public class BytesUtil {
    ...
    public static byte[] toBytes(String value, String encoding) throws UnsupportedEncodingException {
        ...
        String jdkEncoding = JDKCharsetMapper.getJDKECharset(realEncoding);
        return value.getBytes(jdkEncoding);
    }
    ...
    public static String toString(byte[] bytes, String encoding) throws UnsupportedEncodingException {
        ...
        String realEncoding = UTF8_ENCODING;
        if (isValidEncoding(encoding)) {
            realEncoding = JDKCharsetMapper.getJDKECharset(encoding);
        }
    ...
    public static int compareTo(final ByteBuffer left, final ByteBuffer right) {
        if (left == null) {
            return right == null ? 0 : -1;
        } else if (right == null) {
            return 1;
        }
        return compareTo(left.array(), right.array());
    }
