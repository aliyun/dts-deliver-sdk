...
public class Field extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5541075992539396022L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Field\",\"namespace\":\"com.aliyun.dts.deliver.protocol.avro.generated\",\"fields\":[{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"dataTypeNumber\",\"type\":\"int\"}]}");
   ...
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder newBuilder() {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder();
  }
   ...
   * @return A new Field RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder(other);
  }
   ...
   * @return A new Field RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.Field other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Field>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.Field other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder setDataTypeNumber(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Field.Builder clearDataTypeNumber() {
