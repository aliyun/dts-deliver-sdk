...
public class Timestamp extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8482587176628387663L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Timestamp\",\"namespace\":\"com.aliyun.dts.deliver.protocol.avro.generated\",\"fields\":[{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"millis\",\"type\":\"int\"}]}");
   ...
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder newBuilder() {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder();
  }
   ...
   * @return A new Timestamp RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder(other);
  }
   ...
   * @return A new Timestamp RecordBuilder
   */
  public static com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder newBuilder(com.aliyun.dts.deliver.protocol.avro.generated.Timestamp other) {
    return new com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Timestamp>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.aliyun.dts.deliver.protocol.avro.generated.Timestamp other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.timestamp)) {
        this.timestamp = data().deepCopy(fields()[0].schema(), other.timestamp);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder setMillis(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aliyun.dts.deliver.protocol.avro.generated.Timestamp.Builder clearMillis() {
